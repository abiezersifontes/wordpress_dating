...
function sbpp04_update_notice__success() {
    ...
    if( $notice_dismissed != 1 ){
        ...
        $message = "A new admin setting has been added to Simple BuddyPress Profile Privacy. You can now allow members to hide themselves from the directory page. ";
        $link_message = "Click here to update the profile settings";
...
function sbpp04_hide_directory_settings() {
    ...
    <label for="<?php echo SBPP04_ADMIN_HIDE_DIRECTORY_KEY ?>"><?php _e( 'Allow registered members to hide from the directory', SBPP04_PLUGIN_DOMAIN ); ?></label>
    <?php
}
