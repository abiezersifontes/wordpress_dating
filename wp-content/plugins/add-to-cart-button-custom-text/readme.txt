...
So **you could choose up to nine different texts as per the type of product and the place it's displayed**. Just activate it and go to *Settings -> Add to Cart Button* to choose your preferences. Default WooCommerce texts are used for default configuration. **ASCII emojis are supported**.

Supports bookable products (button text customizable only on archive pages) provided by WooCommerce Bookings plugin.

Spanish and catalan translations are available. Other translation contributions are welcome. Visit me on [my web](http://www.enriquejros.com/).
...
No, that isn't yet supported

= How can I put emojis in the button text? =

Just copy from somewhere and paste

= Will the "Book now" text be customizable on product pages? =

May be in the future

= Some texts in the options page are displayed in my language, but some others aren't =
