...
<div id="message-thread">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form">
			...
			<div class="message-box style_23689">
				...
				<div class="message-content">
					...
					?></label>
					<div class="row">
					<div class="columns small-9 large-11 btn_5258">
					<textarea name="content" id="message_content" rows="6" cols="40"></textarea>
				  </div>
					<div class="columns small-3 large-1 btn_5258"><?php
						do_action( 'bp_after_message_reply_box' ); ?>
						<div class="submit">
							<input type="submit" name="send" value="<?php esc_attr_e( '', 'buddypress' ); ?>" id="send_reply_button"/>
						</div>
					</div>
				  </div>
					<?php
