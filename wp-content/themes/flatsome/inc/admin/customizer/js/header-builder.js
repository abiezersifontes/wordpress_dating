jQuery(function ($) {
    ...
    function headerBuilderInit(){
      ...
      // Fix Logo position
      $('.header-builder .hb-desktop .hb-main').removeClass('hb-logo-center');
      if(wp.customize.instance('logo_position').get() == 'center'){
        $('.header-builder .hb-desktop .hb-main').addClass('hb-logo-center');
      }

      $('.header-builder .hb-mobile .hb-main').removeClass('hb-logo-center');
      if(wp.customize.instance('logo_position_mobile').get() == 'center'){
        $('.header-builder .hb-mobile .hb-main').addClass('hb-logo-center');
      }
    }
