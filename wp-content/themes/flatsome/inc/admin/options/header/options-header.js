( function( $ ) {
	...
	wp.customize( 'logo_position', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval == 'center'){
				$('.header-builder .hb-desktop .hb-main', parent.document).addClass('hb-logo-center');
				$('.header-inner').addClass('logo-center');
			} else {
				$('.header-builder .hb-desktop .hb-main',  parent.document).removeClass('hb-logo-center');
				$('.header-inner').addClass('logo-left');
			}
		} );
	} );

	wp.customize( 'logo_position_mobile', function( value ) {
		value.bind( function( newval ) {
			$( '.header-inner' ).removeClass('medium-logo-center');
			if(newval == 'center'){
				$('.header-builder .hb-mobile .hb-main', parent.document).addClass('hb-logo-center');
				$('.header-inner').addClass('medium-logo-center');
			} else {
				$('.header-builder .hb-mobile .hb-main',  parent.document).removeClass('hb-logo-center');
			}
		} );
	} );
