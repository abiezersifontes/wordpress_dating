( function( $ ) {
	...
	wp.customize( 'type_size', function( value ) {
		value.bind( function( newval ) {
			appendStyle('type_size','body {font-size: '+newval+'%;}');
		} );
	} );

	wp.customize( 'type_size_mobile', function( value ) {
		value.bind( function( newval ) {
			appendStyle('type_size_mobile','@media screen and (max-width: 550px){body{font-size: '+newval+'%;}}');
		} );
	} );
