...
add_ux_builder_shortcode( 'ux_products', array(
    ...
    'presets' => array(
            ...
            array(
                ...
                'content' => '[ux_products style="overlay" image_height="160%" image_size="medium" image_overlay="rgba(0, 0, 0, 0.67)" image_hover="color" image_hover_alt="overlay-remove-50" text_size="large"]'
            ), array(
